...
<style>
    ...
    .smSize{resize: none; width: 100%; height: 500px;}
</style>
</head>
<body>
<form action="${pageContext.request.contextPath}/boardModifyProc.bo?seq=${dto.seq}" method="post" id=frm>
            ...
            <div class="row">
               <div id="article-middle" class="col-12 mt-2">
                  <div class="row mb-3 p-1 text-center">
                     <h3 id="board-top" class="col-auto col-sm-4 m-0">${dto.header}게시판</h3>
                     <span class="col-auto col-sm-8 mt-2">글을 수정해주십시오.</span>
                  </div>
                  <div class="row">
                     <div class="col-2 p-1">
                     ...
                     <div class="col-10 p-1">
                        <input type="text" class="space form-control" id="boTitle" name="title">
                     </div>
                  </div>
                  <div class="row">
